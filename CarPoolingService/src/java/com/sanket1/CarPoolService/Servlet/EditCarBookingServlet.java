        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String carbookingTime;
               ...
               carbookingTime = request.getParameter("carbookingTime");
                count = carbookingDAO.updateCarBooking(carbookingID,new CarBooking(carID,customerID,carbookingDate,carbookingTime));
                }
            ...
            if(count>0){
               rd = request.getRequestDispatcher("CarBookingListServlet.view");
            }
            else{
